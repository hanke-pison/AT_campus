...
if("TRUE" STREQUAL "TRUE")
  set(hanke_pison_image_transport_SOURCE_PREFIX /home/hanke/RPI/src/hanke_pison_image_transport)
  set(hanke_pison_image_transport_DEVEL_PREFIX /home/hanke/RPI/devel)
  ...
  set(hanke_pison_image_transport_INSTALL_PREFIX /home/hanke/RPI/install)
...
if(NOT "/home/hanke/RPI/devel/include " STREQUAL " ")
  set(hanke_pison_image_transport_INCLUDE_DIRS "")
  set(_include_dirs "/home/hanke/RPI/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hanke_pison_image_transport' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hanke/RPI/src/hanke_pison_image_transport/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/hanke/RPI/devel/lib;/opt/ros/lunar/lib)
