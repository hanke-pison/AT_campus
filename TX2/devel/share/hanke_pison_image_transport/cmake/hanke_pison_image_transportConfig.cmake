...
if("TRUE" STREQUAL "TRUE")
  set(hanke_pison_image_transport_SOURCE_PREFIX /home/nvidia/AT_campus/TX2/src/hanke_pison_image_transport)
  set(hanke_pison_image_transport_DEVEL_PREFIX /home/nvidia/AT_campus/TX2/devel)
  ...
  set(hanke_pison_image_transport_INSTALL_PREFIX /home/nvidia/AT_campus/TX2/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hanke_pison_image_transport' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/AT_campus/TX2/src/hanke_pison_image_transport/${idir}'.  ${_report}")
    endif()
