...
(cl:in-package hanke_pison_image_transport-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <ResizedImage>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ResizedImage)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hanke_pison_image_transport-msg:<ResizedImage> is deprecated: use hanke_pison_image_transport-msg:ResizedImage instead.")))

(cl:ensure-generic-function 'original_height-val :lambda-list '(m))
(cl:defmethod original_height-val ((m <ResizedImage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hanke_pison_image_transport-msg:original_height-val is deprecated.  Use hanke_pison_image_transport-msg:original_height instead.")
  (original_height m))

(cl:ensure-generic-function 'original_width-val :lambda-list '(m))
(cl:defmethod original_width-val ((m <ResizedImage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hanke_pison_image_transport-msg:original_width-val is deprecated.  Use hanke_pison_image_transport-msg:original_width instead.")
  (original_width m))

(cl:ensure-generic-function 'image-val :lambda-list '(m))
(cl:defmethod image-val ((m <ResizedImage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hanke_pison_image_transport-msg:image-val is deprecated.  Use hanke_pison_image_transport-msg:image instead.")
  (image m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ResizedImage>)))
  ...
  "hanke_pison_image_transport/ResizedImage")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ResizedImage)))
  "Returns string type for a message object of type 'ResizedImage"
  "hanke_pison_image_transport/ResizedImage")
